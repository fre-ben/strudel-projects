...
const bass = s("sawtooth, supersaw")
  .seg(8)
  .n("<-14@5 -14.5@3>*8")
  .distort("2:0.7")
  .orbit(2)
...
const sidechain = s("bd:2!2").bank("RolandTR909")
...
const snare = s("[- cp]*2").bank("RolandTR909")
...
const hat = s("[- hh:4]*4").bank("RolandTR909")
...
$: stack(
  ...
  )._punchcard({height: 100, width: '1200'});
